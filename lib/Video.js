...
var resolveAssetSource=void 0;

if(!global.__BUNDLE_START_TIME__)resolveAssetSource=require('react-native-web/dist/Libraries/Image/resolveAssetSource');else
...
viewConfig={
validAttributes:{},
uiViewClassName:'RCTVideo'},_this.
...
nativeResizeMode=_reactNativeUniversal.NativeModules.UIManager.RCTVideo.Constants.ScaleToFill;
}else if(resizeMode===_VideoResizeMode2.default.contain){
nativeResizeMode=_reactNativeUniversal.NativeModules.UIManager.RCTVideo.Constants.ScaleAspectFit;
}else if(resizeMode===_VideoResizeMode2.default.cover){
nativeResizeMode=_reactNativeUniversal.NativeModules.UIManager.RCTVideo.Constants.ScaleAspectFill;
}else{
nativeResizeMode=_reactNativeUniversal.NativeModules.UIManager.RCTVideo.Constants.ScaleNone;
}
...
_reactNativeUniversal.View.propTypes);


var RCTVideo=(0,_reactNativeUniversal.requireNativeComponent)('RCTVideo',Video,{
nativeOnly:{
src:true,
seek:true,
fullscreen:true}});